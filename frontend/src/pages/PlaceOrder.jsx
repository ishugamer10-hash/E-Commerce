...
const PlaceOrder = () => {
  ...
  const initPay=(order)=>{
    const options={
      key:importmeta.env.VITE_RAZORPAY_KEY_ID,
      amount:order.amount,
...
const onSubmithandler=async(event)=>{
  ...
  return (
    <form className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-top'>
    ...
    <input required onChange={onChangeHandler} name='lastname' value={formData.lastname}  className='border border-gray-300 py-1.5 px-3.5 w-full' type="text" placeholder='lastname' />
</div>
<input required onChange={onChangeHandler} name='email' value={formData.email}  className='border border-gray-300 py-1.5 px-3.5 w-full' type="text" placeholder='Email' />
...
<div className='flex-gap-3'>
    <input required onChange={onChangeHandler} name='zipcode' value={formData.zipcode}  className='border border-gray-300 py-1.5 px-3.5 w-full' type="text" placeholder='Zipcode' />
...
<input required onChange={onChangeHandler} name='phone' value={formData.phone}  className='border border-gray-300 py-1.5 px-3.5 w-full' type="text" placeholder='Phone' />
    </div>
